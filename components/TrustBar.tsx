  ...
  return (
    <div style={{ background:'#172A2E', borderTop:'1px solid rgba(189,154,100,.18)', padding:'13px clamp(20px,5vw,80px)', textAlign:'center' }}>
      <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:10, flexWrap:'wrap' }}>
        ...
        <span style={{ display:'flex', alignItems:'center', gap:6, fontFamily:"'Jost',sans-serif", fontSize:13.5, fontWeight:300, color:'#F3EFE7', opacity:.9 }}>
        ...
        <span style={{ fontFamily:"'Jost',sans-serif", fontSize:11, letterSpacing:'.24em', textTransform:'uppercase', color:'#F3EFE7', opacity:.62 }}>
