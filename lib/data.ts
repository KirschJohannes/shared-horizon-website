...
export const hotspots: Hotspot[] = [
  ...
  { id:'kueche2', x:49.5, y:50,   n:4, title:'Vollausgestattete Küche', text:'Die vollausgestattete Küche mit Kücheninsel und direktem Blick aufs Wasser. Kochen, anrichten und gleichzeitig dabei sein.',          ideas:'Show-Cooking · Catering · Frühstück',  facts:'Kücheninsel · Wasserblick',             img:'/images/das_boot/jr2.webp' },
  ...
  { id:'bad',     x:62.9, y:50,   n:6, title:'Bad mit Blick aufs Wasser', text:'Das Bad liegt an der Außenwand — Tageslicht und Seeblick inklusive. Ankommen und durchatmen.',                                      ideas:'Wellness · Auszeit',                    facts:'Bad · direkter Wasserblick',            img:'/images/das_boot/bad.webp' },
  ...
  { id:'steuer',  x:84.6, y:84.4, n:8, title:'Steuerstand',             text:'Der Steuerstand mit direktem Blick aufs Wasser — das Herzstück des Bootes und ein besonderer Platz an Bord.',                          ideas:'Ausblick · Erlebnis · Foto-Moment',     facts:'Steuerstand · Wasserblick',             img:'/images/Production/produktion1.webp' },
...
export const gallery: GalleryItem[] = [
  // ─── Kulinarisches ───────────────────────────────────────────────────────────
  { id:'k01', cat:'kulinar', h:260, cap:'Catering an Bord',              alt:'Catering beim Kick-Off Event September 2025, Shared Horizon Berlin',                              src:'/images/Kulinarisches/kick-off_09-25_35.webp' },
  ...
  { id:'k03', cat:'kulinar', h:260, cap:'Köstlichkeiten an Bord',        alt:'Köstlichkeiten beim Kick-Off auf der Shared Horizon Eventlocation, Berlin',                       src:'/images/Kulinarisches/kick-off_09-25_46.webp' },
  ...
  { id:'k05', cat:'kulinar', h:260, cap:'Feines Catering',               alt:'Catering der Kivent Sommerparty auf der Shared Horizon, Eventlocation am Wasser Berlin',          src:'/images/Kulinarisches/kivent_sommerparty_32_von_154.webp' },
  ...
  { id:'k07', cat:'kulinar', h:260, cap:'Food-Moment',                   alt:'Food-Styling Kivent Sommerparty auf der Shared Horizon Eventlocation, Berlin',                    src:'/images/Kulinarisches/kivent_sommerparty_34_von_154.webp' },
  ...
  { id:'k09', cat:'kulinar', h:260, cap:'Kulinarik an Bord',             alt:'Kulinarik der Kivent Sommerparty an Bord der Shared Horizon, Berlin',                             src:'/images/Kulinarisches/kivent_sommerparty_36_von_154.webp' },
  ...
  { id:'k11', cat:'kulinar', h:260, cap:'Genuss auf dem Wasser',         alt:'Kulinarisches Highlight der Shared Horizon Eventlocation Berlin — Tischkultur am Wasser',         src:'/images/Kulinarisches/the_12_highlights_1.webp' },
  ...
  { id:'k13', cat:'kulinar', h:260, cap:'Kulinarischer Genuss',          alt:'Genussmomente auf der Shared Horizon, außergewöhnliche Eventlocation am Wasser Berlin',           src:'/images/Kulinarisches/the_12_highlights_3.webp' },
  { id:'k14', cat:'kulinar', h:260, cap:'Tischkultur',                   alt:'Kulinarisches Erlebnis auf der Shared Horizon Eventlocation am Wasser, Berlin-Schmöckwitz',       src:'/images/Kulinarisches/the_12_highlights_49.webp' },
  ...
  { id:'b06', cat:'boot', h:260, cap:'Außenansicht',                     alt:'Außenblick auf die Shared Horizon Eventlocation am Wasser, Berlin',                               src:'/images/das_boot/g27.webp' },
  ...
  { id:'b09', cat:'boot', h:260, cap:'Licht & Raum',                     alt:'Licht und Raum an Bord der Shared Horizon, Eventlocation Berlin am Wasser',                       src:'/images/das_boot/g38.webp' },
  ...
  { id:'b16', cat:'boot', h:260, cap:'Wohnküche an Bord',                alt:'Wohnküche an Bord der Shared Horizon, vollausgestattete Küche, Eventlocation Berlin',             src:'/images/das_boot/jr2.webp' },
  ...
  { id:'p02', cat:'production', h:400, cap:'Produktion an Bord',          alt:'Produktionsfoto der Shared Horizon Eventlocation, Berlin-Schmöckwitz',                           src:'/images/Production/g52.webp' },
  ...
  { id:'p04', cat:'production', h:280, cap:'Fotoproduktion',              alt:'Shared Horizon Fotoproduktion — Produktionsbild der Eventlocation Berlin am Wasser',             src:'/images/Production/hausboot_set_4_07.webp' },
  ...
  { id:'p06', cat:'production', h:400, cap:'Produktion am Wasser',        alt:'Eventproduktion an Bord der Shared Horizon Eventlocation am Wasser, Berlin',                     src:'/images/Production/produktion2.webp' },

  // ─── Details ──────────────────────────────────────────────────────────────────
  { id:'d01', cat:'details', h:260, cap:'Details an Bord',               alt:'Hochwertige Details an Bord der Shared Horizon Eventlocation, Berlin am Wasser',                  src:'/images/Details/g11.webp' },
  ...
  { id:'d03', cat:'details', h:260, cap:'Einrichtungsdetail',            alt:'Einrichtungsdetail an Bord der Shared Horizon Eventlocation, Berlin',                             src:'/images/Details/g33.webp' },
  ...
  { id:'d05', cat:'details', h:260, cap:'Interieur im Detail',           alt:'Interieur-Detail an Bord der Shared Horizon Hausboot Eventlocation, Berlin',                      src:'/images/Details/g37.webp' },
  ...
  { id:'d07', cat:'details', h:260, cap:'Licht & Ambiente',              alt:'Stimmungsvolles Ambiente im Detail, Shared Horizon Eventlocation Berlin',                         src:'/images/Details/g40.webp' },
  ...
  { id:'d09', cat:'details', h:260, cap:'Einrichtung im Detail',         alt:'Hochwertige Einrichtung der Shared Horizon Hausboot Eventlocation, Berlin',                       src:'/images/Details/g46.webp' },
  ...
  { id:'s02', cat:'sport', h:400, cap:'Sport am Wasser',                 alt:'Sport und Wasser bei der Shared Horizon Eventlocation, Berlin am See',                            src:'/images/sport_und_wasser/g15.webp' },
  ...
  { id:'s05', cat:'sport', h:400, cap:'Outdoor am Wasser',               alt:'Outdoor-Aktivitäten am Wasser der Shared Horizon Eventlocation, Berlin am See',                   src:'/images/sport_und_wasser/g51.webp' },
  ...
  { id:'s07', cat:'sport', h:260, cap:'Outdoor-Aktivität',               alt:'Outdoor-Aktivität am Wasser beim Kick-Off auf der Shared Horizon, Berlin',                        src:'/images/sport_und_wasser/kick-off_09-25_81.webp' },

  // ─── Eventfotos ───────────────────────────────────────────────────────────────
  { id:'e01', cat:'event', h:260, cap:'Kick-Off September 2025',         alt:'Kick-Off Event September 2025 an Bord der Shared Horizon Eventlocation, Berlin',                  src:'/images/Eventfotos/kick-off_09-25_40.webp' },
  ...
  { id:'e03', cat:'event', h:260, cap:'Event Highlight',                 alt:'Event Highlight an Bord der Shared Horizon Eventlocation, Berlin-Schmöckwitz',                    src:'/images/Eventfotos/the_12_highlights_18.webp' },
  ...
  { id:'e05', cat:'event', h:260, cap:'Highlight am Wasser',             alt:'Eventfoto der Shared Horizon Eventlocation am Wasser, Berlin-Schmöckwitz',                        src:'/images/Eventfotos/the_12_highlights_66.webp' },
  { id:'e06', cat:'event', h:260, cap:'Abendveranstaltung',              alt:'Abendveranstaltung auf der Shared Horizon Eventlocation, Berlin am Wasser',                       src:'/images/Eventfotos/the_12_highlights_73.webp' },
  { id:'e07', cat:'event', h:260, cap:'Eventfoto',                       alt:'Eventfoto der Shared Horizon Eventlocation am Wasser, exklusive Location Berlin',                 src:'/images/Eventfotos/the_12_highlights_89.webp' },
  ...
  { id:'e09', cat:'event', h:260, cap:'Firmenevent Highlight',           alt:'Firmenevent Highlight der Shared Horizon Eventlocation, Berlin-Schmöckwitz',                      src:'/images/Eventfotos/the_12_highlights_93.webp' },
  ...
  { id:'st02', cat:'stimmung', h:400, cap:'Atmosphäre am Abend',         alt:'Atmosphärisches Bild der Shared Horizon Eventlocation am Abend, Berlin am Wasser',                src:'/images/Stimmung/g28.webp' },
  ...
  { id:'st04', cat:'stimmung', h:400, cap:'Atmosphäre an Bord',          alt:'Atmosphäre an Bord der Shared Horizon Eventlocation am Wasser, Berlin',                           src:'/images/Stimmung/hausboot_06.webp' },
  ...
  { id:'st06', cat:'stimmung', h:400, cap:'Abendstimmung',               alt:'Abendstimmung auf der Shared Horizon Eventlocation am Wasser, Berlin',                            src:'/images/Stimmung/hausboot_08.webp' },
  ...
  { id:'st08', cat:'stimmung', h:400, cap:'Am Wasser',                   alt:'Stimmungsbild der Shared Horizon Eventlocation am Wasser, Berlin-Schmöckwitz',                    src:'/images/Stimmung/hausboot_10.webp' },
  ...
  { id:'st10', cat:'stimmung', h:400, cap:'Abendlicht am See',           alt:'Shared Horizon Eventlocation bei Abendlicht am See, Berlin-Schmöckwitz',                          src:'/images/Stimmung/hausboot_set_3_08.webp' },
  ...
  { id:'st12', cat:'stimmung', h:400, cap:'Atmosphäre bei Sonnenuntergang', alt:'Atmosphäre auf der Shared Horizon Eventlocation bei Sonnenuntergang, Berlin',                  src:'/images/Stimmung/hausboot_set_4_04.webp' },
  ...
  { id:'ga04', cat:'gesamt', h:400, cap:'Vom Wasser aus',                alt:'Shared Horizon Hausboot vom Wasser aus gesehen, Eventlocation Berlin-Schmöckwitz',                src:'/images/Gesamtansicht/hausboot_set_3_05.webp' },
  ...
  { id:'ga06', cat:'gesamt', h:400, cap:'Yachthafen Schmöckwitz',        alt:'Shared Horizon am Yachthafen Berlin-Schmöckwitz, Eventlocation vom Wasser aus gesehen',           src:'/images/Gesamtansicht/hausboot_set_3_07.webp' },
];
